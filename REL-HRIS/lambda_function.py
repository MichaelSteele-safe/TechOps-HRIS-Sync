...
NS_ACCOUNT = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/ACCOUNT')
NS_CONSUMER_KEY = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/CONSUMER_KEY')
NS_CONSUMER_SECRET = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/CONSUMER_SECRET')
NS_TOKEN_KEY = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/TOKEN_KEY')
NS_TOKEN_SECRET = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/TOKEN_SECRET')
NS_APPID = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/APPID')
NS_HOST = aws_functions.get_access_token('/TechOps/Netsuite/Sandbox/HOST')

def make_netsuite_request(url, obj, http_method):
    """
...
def lambda_handler(event, context):
    ...
    url = "https://436874-sb1.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=582&deploy=1"
    objType = "vendor" if body["type"] == "vendor" else "employee"
    try:
        obj = [
                {
                    "action":"add",
        ...
        response = make_netsuite_request(url, obj, "POST")
